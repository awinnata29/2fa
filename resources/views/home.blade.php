...
<div class="app">
    <header class="topbar">
        <a class="logo" href="/" aria-label="2FAKU home">
            <span class="logo-mark"><img src="{{ asset('images/logo.png') }}" alt="" width="43" height="43"></span>
        ...
        <nav class="main-nav" aria-label="Navigasi utama">
            ...
            <a class="nav-link" href="https://etulis.com" target="_blank" rel="noopener noreferrer"><svg viewBox="0 0 24 24"><path d="M6 3h9l3 3v15H6z"/><path d="M15 3v4h4M9 11h6M9 15h6"/></svg><span>Notepad</span><small>&nearr;</small></a>
        </nav>
    ...
    <main id="uidPage" class="uid-page app-page {{ $isUidPage ? '' : 'hidden' }}" @unless($isUidPage) hidden @endunless>
        <section class="uid-workspace">
            ...
            <section class="uid-promotions" aria-labelledby="uidPromoTitle">
                <div class="promo-heading"><div><span class="overline">REKOMENDASI</span><h2 id="uidPromoTitle">Partner pilihan</h2></div><span class="sponsored-label">Sponsored</span></div>
                <div class="uid-promo-grid">
                    <a class="ad-banner" href="https://akundigital.id" target="_blank" rel="noopener sponsored" aria-label="Kunjungi AkunDigital — Marketplace digital terpercaya">
                        <img src="{{ asset('images/ads/akundigital-banner-1.png') }}" alt="AkunDigital, marketplace digital terpercaya dengan harga murah dan terjangkau" width="2172" height="724" loading="lazy">
                        <span class="ad-overlay">Kunjungi situs <b>↗</b></span>
                    </a>
                    <a class="ad-banner" href="https://akundigital.id" target="_blank" rel="noopener sponsored" aria-label="Kunjungi AkunDigital — Marketplace digital terpercaya">
                        <img src="{{ asset('images/ads/akundigital-banner-2.png') }}" alt="AkunDigital, marketplace digital terpercaya untuk akun sosial media, iklan, dan AI tools" width="2172" height="724" loading="lazy">
    ...
    <footer class="page-footer">
        ...
        <div class="footer-brand"><span class="footer-mark"><img src="{{ asset('images/logo.png') }}" alt="" width="30" height="30"></span><div><b>2FAKU<span>.COM</span></b><small>© {{ date('Y') }} · All rights reserved</small></div></div>
        <div class="footer-line"></div>
    </footer>
</div>
